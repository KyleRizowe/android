...
public class LogManager {
    ...
    static {
        initCompatibility();
        debugable = (getApplicationInfo(CarryThisTooApplication.Companion.applicationContext()).flags & ApplicationInfo.FLAG_DEBUGGABLE) != 0;
        log = debugable;
    }
    ...
    static {
        instance = new LogManager(CarryThisTooApplication.Companion.applicationContext());
