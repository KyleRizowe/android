...
public class CZResponse<T> {
    ...
    public CZResponse(int responseCode, T response, Headers headers) {
        super();
        this.responseCode = responseCode;
        this.response = response;
    ...
    public CZResponse(int responseCode, T response, ResponseBody responseError, Headers headers) {
        super();
        this.responseCode = responseCode;
        this.response = response;
    ...
    public CZResponse(int responseCode, ArrayList<T> responseList) {
        super();
        this.responseCode = responseCode;
        this.responseList = responseList;
    }

    public CZResponse(int responseCode, ArrayList<T> responseList, Headers headers) {
        super();
        this.responseCode = responseCode;
        this.responseList = responseList;
        this.headers = headers;
